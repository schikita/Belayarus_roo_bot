...
def get_info_keyboard() -> InlineKeyboardMarkup:
    ...
    button_contacts = InlineKeyboardButton(
        text="Контакты", callback_data="info_contacts"
    )
    button_addresses = InlineKeyboardButton(
        text="Адреса отделений", callback_data="info_addresses"
    )
    button_faq = InlineKeyboardButton(text="Частые вопросы", callback_data="info_faq")
