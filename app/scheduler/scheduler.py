...
async def send_periodic_message(bot: Bot, chat_id: str):
    ...
    """
    try:
        scheduler_logger.info(f"Attempting to send a scheduled message to chat_id: {chat_id}")
        ...
        scheduler_logger.error(f"Failed to send scheduled message to chat_id: {chat_id}. Error: {e}")
